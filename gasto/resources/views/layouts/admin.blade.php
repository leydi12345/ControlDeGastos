        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <img class="img-xs rounded-circle" src="images/faces/face10.jpg" alt="Profile image">
            </a>
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                <div class="profile-image">
                  <img src="images/faces/face10.jpg" alt="profile image">
                </div>
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                  <a class="nav-link" href="{{url('/ingreso/ingreso')}}">ingreso</a>
                </li>
              </ul>
            </div>
          </li>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body" style="background-color: #F2A9E9">
